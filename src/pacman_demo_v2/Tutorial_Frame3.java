 ...
 * @author luuhu
 */
public class Tutorial_Frame3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lbnext);
        lbnext.setBounds(170, 540, 130, 50);
        ...
        lbbackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Tut3.png"))); // NOI18N
        ...
        lbbackground.setBounds(0, 0, 621, 621);
    ...
    private void lbnextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbnextMouseClicked
        // TODO add your handling code here:
        Tutorial_Frame4 tut = new Tutorial_Frame4();
        tut.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tutorial_Frame3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tutorial_Frame3().setVisible(true);
            }
        });
    }
