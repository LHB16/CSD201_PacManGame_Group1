 ...
 * @author luuhu
 */
public class Tutorial_Frame4 extends javax.swing.JFrame {

    /**
     * Creates new form StartMenu_Frame
     */
    public Tutorial_Frame4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(lbnext);
        lbnext.setBounds(330, 544, 130, 60);
        ...
        jPanel1.add(lbback);
        lbback.setBounds(170, 550, 120, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tutorial_Frame4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tutorial_Frame4().setVisible(true);
            }
        });
    }
